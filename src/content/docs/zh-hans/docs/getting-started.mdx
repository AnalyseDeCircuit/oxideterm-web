---
title: 简介
description: OxideTerm — 基于纯 Rust SSH 和现代 Web 技术构建的本地优先 SSH 工作区。
---

**OxideTerm** 是一个**本地优先的 SSH 工作区**，不只是一个终端。打开一次远程节点后，你可以在同一处围绕它使用 Shell、SFTP、端口转发、trzsz 传输、轻量编辑、本地 Shell 和 BYOK 优先的 OxideSens AI。
...
| **插件** | ESM Runtime | 官方 Cloud Sync、Quick Commands、Telnet Client 和运行时扩展 API |
...
- [OxideSens AI](/zh-hans/docs/features/ai/) — 面向 SSH 工作区的 target-first BYOK AI
