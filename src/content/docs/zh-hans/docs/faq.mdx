...
OxideTerm 是一个基于 Tauri 2.0（Rust）和 React 19（TypeScript）构建的**本地优先 SSH 工作区**。它把 SSH 终端、本地 Shell、SFTP、IDE 模式、端口转发、trzsz 传输、BYOK AI 辅助、插件系统、主题和 11 种语言整合在一个原生应用里。
...
- **Quick Commands**：保存、组织并按主机筛选常用终端命令。
