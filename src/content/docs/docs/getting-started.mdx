...
| **IDE Mode** | CodeMirror 6 with 24 languages, file tree + Git status, multi-tab with LRU management, conflict resolution (mtime locking), integrated terminal. Optional remote agent (9 architectures) |
