...
|----------|--------------------|
| **Windows** | [WebView2 Runtime](https://developer.microsoft.com/en-us/microsoft-edge/webview2/) — pre-installed on Windows 10 (1803+) and Windows 11. For air-gapped or intranet environments, use the Evergreen Standalone Installer or deploy the Fixed Version runtime via group policy. |
