...
236,000+ lines of Rust & TypeScript.

## Connections

### How are passwords stored?

Passwords are stored in your operating system's native keychain (Keychain Access on macOS, Windows Credential Manager, Secret Service on Linux). They are **never** stored in configuration files, databases, or plaintext.
...
- 43 JSON-RPC methods
- Auto-deploys on x86_64/aarch64 Linux; 9 architectures available for manual upload
