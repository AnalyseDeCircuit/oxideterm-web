...
OxideTerm is an AI-native SSH workspace built with Tauri 2.0 (Rust) and React 19 (TypeScript). It combines SSH terminal, local PTY, SFTP, IDE mode, port forwarding, AI assistance, plugins, 31+ themes, and 11 languages into a single native application.
